...
const STATIC_ROUTE_SEO = {
  ...
  '/katalog': {
    title: 'Каталог със специалисти, услуги и продукти | Totsan',
    description: 'Намери проверени специалисти, одобрени услуги и подбрани продукти за петте слоя на ремонта, строителството и обзавеждането.',
  },
  '/pro': {
  ...
  '/kak-raboti': {
    ...
    description: 'Виж как Totsan подрежда проекта ти в пет слоя и те води от brief до правилния специалист, услуга или продукт.',
  },
  '/za-nas': {
    title: 'За Totsan',
  ...
  '/kuhni': {
    title: 'Кухни | Totsan',
    description: 'Разгледай кухни, мебели по поръчка и свързани специалисти и продукти за слоя на обзавеждането.',
  },
  '/spalnya-i-dnevna': {
    title: 'Спалня и дневна | Totsan',
    description: 'Идеи и решения за спалня и дневна с правилните специалисти, продукти и следващи стъпки в Totsan.',
  },
  '/banya': {
    title: 'Баня | Totsan',
    description: 'Специалисти, услуги и продукти за баня, довършителни работи и обзавеждане през Totsan.',
  },
...
export function getDefaultSeo(pathname = '/') {
  ...
  if (/^\/produkt\/[^/]+$/u.test(canonicalPath)) {
    return {
      title: 'Продукт | Totsan',
      description: 'Разгледай продуктова страница в Totsan с контекст, слой, свързани специалисти и следваща стъпка към запитване.',
      canonicalPath,
    }
  }
