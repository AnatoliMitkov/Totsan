  ...
  return (
    <div className="space-y-3">
      <div className="rounded-3xl border border-blue-100 bg-blue-50 p-4 text-sm leading-6 text-blue-900">
        ...
        <p className="mt-1">
          Преди изпращане на платени оферти партньорът трябва да поддържа актуални име/фирма, ЕИК/Булстат или приложим идентификатор, адрес, лице за контакт, имейл, телефон и ЗДДС статус. Плащането по проекта може да мине през Totsan и Stripe; банковите и payout данни се обработват в защитен платежен контекст и не се показват публично.
        </p>
        <p className="mt-2">
