        ...
        <div className="grid lg:grid-cols-12 gap-12 items-center mb-16">
          ...
          <div className="lg:col-span-7 reveal">
            <p className="text-muted leading-relaxed text-base">
              Често дворът остава на заден план след ремонт на интериора. В Totsan съчетаваме ландшафтни архитекти с изпълнители на автоматизирани системи, настилки и перголи. Подреждаме процеса стъпка по стъпка, за да има по-ясен обхват, оферта и следващо действие.
            </p>
          </div>
        </div>
