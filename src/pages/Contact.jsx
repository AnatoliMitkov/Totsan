...
const CONTACT_ROUTES = {
  ...
  payment: {
    ...
    helper: 'За партньорски абонаменти, фактури от Totsan, проектни плащания, задържани суми, преводи, refunds или disputes.',
    placeholder: 'Опиши въпроса за абонамента, фактурата, поръчката или плащането и добави номер, ако имаш такъв.',
