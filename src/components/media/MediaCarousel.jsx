              ...
              <div className="group relative block w-full overflow-hidden rounded-[2rem] border border-paper bg-ink shadow-[0_30px_90px_rgba(13,35,64,0.22)]">
                {isYoutubeVideo(activeImage) ? (
                  ...
                  >
                    ...
                    />
                    <span className="pointer-events-none absolute right-3 top-3 inline-flex h-10 w-10 items-center justify-center rounded-full border border-paper/25 bg-ink/48 text-paper shadow-lg backdrop-blur transition group-hover:bg-ink/62 sm:h-auto sm:w-auto sm:gap-2 sm:px-3 sm:py-2 sm:text-xs sm:font-semibold">
                      <Maximize2 size={15} />
